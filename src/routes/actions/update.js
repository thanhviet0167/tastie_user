const { url_update, url_get_access_token, url_change_password, url_add_to_favorite, url_remove_to_favorite, url_submit_upcoming_product_review } = require("../../constant/url");
